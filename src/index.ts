((factory, downloadNodeJs, downloadWeb, build) => {
    ...
    downloadNative: (uri: string, amdLoader) => Promise<Function>, 
    createModule: (callback: Function, results: any[], exports: any, uris: string[], extra: any) => any, 
    req, 
    exports
) => {
    "use strict";
...
}, (url: string, amdLoader): Promise<Function> => {
    var fs = require('fs');
